...
const { createNews, updateNews, getSingleNews, getAllNews, getOnlyLatestNews, getNewsByCategory, showOnlyRelatedNewsByCategory, deleteNews, deleteAllNews, MakeNewsShowSlider, MakeNewsShowAtLatest, addImageFieldInAllNews, DeactivateNewsShowSlider, DeactivateNewsShowAtLatest, toggleisPopular } = require('../controllers/NewsController');
...
router.put('/toggle-update/:id', toggleisPopular);
